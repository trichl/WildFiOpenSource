...
#define WILDFI_CONFIG_NAME                              "PARAGLIDERS"
#define WILDFI_CONFIG_VERSION                           13
...
#define ACC_INTERRUPT_WATERMARK                         980                             // fine for <= 50Hz, other stuff not tested, imu is generating interrupt when fifo is at that fill level
