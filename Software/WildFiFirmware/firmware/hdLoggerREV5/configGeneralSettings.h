...
const char* FORCE_DOWNLOAD_WIFI_SSID =                  "download";                     // mpiforce, enter special mode during get time state when this wifi is seen
const char* FORCE_DOWNLOAD_WIFI_PASSWORD =              "ABCDEFGH";                     // ABCDEFGH, NOT RELEVANT (ignored), enter special mode during get time state when this wifi is seen
