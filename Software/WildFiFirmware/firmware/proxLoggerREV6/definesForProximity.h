...
#define NVS_FLASH_BUFFER_NAME                           "flashbuff"                     // 512 byte blob buffer in NVS for flash memory
...
#define GPS_FIX_HOURS_9_TO_5				            0x7FC0 // 0b000000000111111111000000
#define GPS_FIX_HOUR_0						            (1UL << 23)
#define GPS_FIX_HOUR_1			            			(1UL << 22)
#define GPS_FIX_HOUR_2						            (1UL << 21)
#define GPS_FIX_HOUR_3	            					(1UL << 20)
#define GPS_FIX_HOUR_4	            					(1UL << 19)
#define GPS_FIX_HOUR_5	            					(1UL << 18)
#define GPS_FIX_HOUR_6	            					(1UL << 17)
#define GPS_FIX_HOUR_7	            					(1UL << 16)
#define GPS_FIX_HOUR_8		            				(1UL << 15)
#define GPS_FIX_HOUR_9		            				(1UL << 14)
#define GPS_FIX_HOUR_10		            				(1UL << 13)
#define GPS_FIX_HOUR_11		            				(1UL << 12)
#define GPS_FIX_HOUR_12		            				(1UL << 11)
#define GPS_FIX_HOUR_13		            				(1UL << 10)
#define GPS_FIX_HOUR_14		            				(1UL << 9)
#define GPS_FIX_HOUR_15		            				(1UL << 8)
#define GPS_FIX_HOUR_16			            			(1UL << 7)
#define GPS_FIX_HOUR_17			            			(1UL << 6)
#define GPS_FIX_HOUR_18			               			(1UL << 5)
#define GPS_FIX_HOUR_19			            			(1UL << 4)
#define GPS_FIX_HOUR_20			            			(1UL << 3)
#define GPS_FIX_HOUR_21				            		(1UL << 2)
#define GPS_FIX_HOUR_22				            		(1UL << 1)
#define GPS_FIX_HOUR_23					            	(1UL)

/** State enums */
typedef enum { ST_BOOT = 0, ST_SERIAL_MENUE, ST_FIRST_START, ST_GET_TIME, ST_ACTIVATION, ST_START, ST_TRACK, ST_PWRDWN, ST_RF_FULL_CALIB, ST_FULL_RESET } tracker_state_t;
