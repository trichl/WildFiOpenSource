...
#define WILDFI_CONFIG_NAME                              "STANDREWS"
...
#define TRACKING_DATA_MODE                              TRACKING_DATA_MODE_1HZ_GPS_AND_ACC // select tracking firmware: TRACKING_DATA_MODE_1HZ_GPS_AND_ACC or TRACKING_DATA_MODE_ACC_ONLY or TRACKING_DATA_MODE_IMU_HD_LIGHT_SLEEP
...
#define NIGHTTIME_ENTER                                 NIGHTTIME_ALWAYS_NIGHT          // NIGHTTIME_ALWAYS_NIGHT or NIGHTTIME_USE_HOURS or NIGHTTIME_DISABLED -> when activated then logger stops logging at certain time of day
#define NIGHTTIME_MODE                                  NIGHTTIME_MODE_TRY_DATATRANS    // NIGHTTIME_MODE_ONLY_SLEEP or NIGHTTIME_MODE_TRY_DATATRANS
// ONLY FOR NIGHTTIME_USE_HOURS
...
#define ACC_INTERRUPT_WATERMARK                         960                             // 960 fine for <= 50Hz, 918 for 200Hz (Acc only), other stuff not tested, imu is generating interrupt when fifo is at that fill level
