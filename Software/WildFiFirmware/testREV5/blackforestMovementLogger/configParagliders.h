...
#define NIGHTTIME_MODE_TRY_DATATRANS_WAKEUP_SECONDS     180                             // 180, in seconds, MAX 4096, ESPNOW_CUSTOM_RF_CALIBRATION = true and GPS backup current: 900 = every 15min: 28uA, 300 = every 5min: 48.4uA
...
#define COMMAND_BYTE_FORCE_TRACKING_MAX                 2                               // this is the maximum amount of times a forced tracking can be issued per day
