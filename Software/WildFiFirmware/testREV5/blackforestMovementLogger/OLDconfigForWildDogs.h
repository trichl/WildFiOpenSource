...
#define TRACKING_DATA_MODE                              TRACKING_DATA_MODE_1HZ_GPS_AND_ACC  // TRACKING_DATA_MODE_1HZ_GPS_AND_ACC or TRACKING_DATA_MODE_ACC_ONLY
...
#define TRANSMISSION_METHOD                             TRANSMISSION_METHOD_ESP_NOW     // how to transmit data
...
#define NIGHTTIME_TURN_ON_HOUR                          12                              // start again logging at this UTC hour
#define NIGHTTIME_TURN_ON_MINUTE                        20                              // start again logging at this UTC minute
#define NIGHTTIME_TURN_OFF_HOUR                         12                              // stop logging at this UTC hour
#define NIGHTTIME_TURN_OFF_MINUTE                       33                              // stop logging at this UTC minute
...
#define FIRST_UNDER_VOLTAGE_SLEEP_TIME                  30                              // 1*3600, first time UV detected -> stop imu fifo and sleep for that time
#define FOLLOWING_UNDER_VOLTAGE_SLEEP_TIME              60                              // 12*3600, second and more times UV detected -> sleep for that time
