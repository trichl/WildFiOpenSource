...
#define WILDFI_CONFIG_NAME                              "WILDDOGSFINAL"
#define WILDFI_CONFIG_VERSION                           11
...
#define ACC_FREQUENCY                                   BMX160_ACCEL_ODR_12_5HZ
...
#define NIGHTTIME_TURN_OFF_HOUR                         6                               // stop logging at this UTC hour
...
#define NIGHTTIME_MODE_TRY_DATATRANS_MODULO             3                               // 3, only every X times of wake ups (NIGHTTIME_MODE_TRY_DATATRANS_EVERY_SECONDS) try data transmission, otherwise just check if night time is over
...
#define SKIP_GET_TIME                                   true                            // true, starting without any time (get it maybe later over GPS)
...
#define TIME_BETWEEN_GET_TIME_RETRIES_SECONDS           3600                            // 3600, 120 = 660uA, if not activated: sleep for that time, wake up, check if wifi there and try to activate, 120 = 234uA average

/** Activation */
#define ACTIVATION_MODE                                 ACTIVATION_MODE_STORE_PERMANENTLY  // ACTIVATION_MODE_SKIP or ACTIVATION_MODE_STORE_PERMANENTLY or ACTIVATION_MODE_ON_EVERY_START: how shall the tag be activated
