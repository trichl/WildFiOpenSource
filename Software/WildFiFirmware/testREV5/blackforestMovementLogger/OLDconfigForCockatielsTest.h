...
#define TAG_NAME                                        "COCKTT"                        // ALWAYS 6 CHARACTERS! otherwise REST_ADD_HEADER_VALUE not correct, unique id for post calls
#endif
...
#define NIGHTTIME_ACTIVATED                             false                           // when activated then loggers stops logging at certain time of day
